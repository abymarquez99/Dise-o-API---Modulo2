...
class Server {
  constructor() {
    ...
    this.paths = {
      user: "/api/users",
      headerInvoice: "/api/headerInvoice",
  ...
  routes() {
    ...
    this.app.use(this.paths.headerInvoice, require("../routes/headerInvoice.routes"));
    this.app.use(this.paths.invoiceDetail, require("../routes/invoiceDetail.routes"));
